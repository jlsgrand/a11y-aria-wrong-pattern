 ...
 *  to format the text in a mainText element
 * @param domNode
...
FormatToolbar.prototype.init = function () {
    ...
    this.mainText = document.getElementById(
        this.domNode.getAttribute('aria-controls')
    );
    this.mainText.style.width =
...
FormatToolbar.prototype.changeFontSize = function (value) {
    this.mainText.style.fontSize = value + 'pt';
};

FormatToolbar.prototype.changeContentWidth = function (value) {
    this.mainText.style.width = value + 'px';
};

FormatToolbar.prototype.toggleNightMode = function () {
    if (this.nightModeCheck.checked) {
        this.mainText.style.color = '#eee';
        this.mainText.style.background = 'black';
    } else {
        this.mainText.style.color = 'black';
        this.mainText.style.background = 'white';
    }
};
...
FormatToolbar.prototype.setFontFamily = function (font) {
    this.mainText.style.fontFamily = font;
};
...
FormatToolbarItem.prototype.init = function () {
    ...
    if (this.domNode.classList.contains('spinbutton')) {
        ...
        // TODO gérer aussi la taille du main
    }
...
var SpinButton = function (domNode, toolbar) {
    ...
    this.valueMin = domNode.ariaValueMin;
    this.valueMax = domNode.ariaValueMax;
    this.valueNow = domNode.ariaValueNow;
    this.valueUnit = domNode.dataset.unit
    this.valueText = this.valueNow + this.valueUnit;
    this.action = domNode.dataset.action
...
SpinButton.prototype.setValue = function (value) {
    ...
    console.log(this.valueDomNode);
    this.valueNow = value;
    this.valueText = value + this.valueUnit;
    ...
    if (this.action === 'content-width') {
        this.toolbar.changeContentWidth(value);
    } else if (this.action === 'font-size') {
